...
export const metadata: Metadata = {
  ...
  description: `${SITE.name} helps local businesses in ${SITE.region} get found and recommended by AI assistants like ChatGPT, Claude, and Perplexity. Audits, schema, NAP cleanup, review systems, and ongoing monitoring.`,
  alternates: { canonical: "/" },
  openGraph: {
    type: "website",
    title: `${SITE.name} | ${SITE.role}`,
    description: `Answer Engine Optimization for local businesses. Get found by ChatGPT, Claude, and Perplexity.`,
    url: "/",
    siteName: SITE.name,
  },
  twitter: {
