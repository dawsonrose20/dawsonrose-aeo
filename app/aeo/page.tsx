...
const faqs = [
  ...
  },
  {
    ...
    a: 'Gartner projects that roughly 25% of organic search traffic will shift to AI assistants. For a local query like "plumber near Quincy MA", the AI considers a small pool of sources before citing 1–3. That makes the work to enter and survive the citation cut unusually tractable for local businesses, and the businesses that move first take the seats.',
  },
  {
...
export const metadata: Metadata = {
  ...
  title: `${SITE.name} | Answer Engine Optimization`,
  description:
    "Learn how Answer Engine Optimization can improve your visibility in AI-powered search engines. Optimize your content for answer engines like Perplexity, ChatGPT, and Claude.",
  alternates: { canonical: new URL("/aeo", SITE.url).toString() },
  openGraph: {
    title: `${SITE.name} | Answer Engine Optimization`,
    description:
      "Learn how Answer Engine Optimization can improve your visibility in AI-powered search engines. Optimize your content for answer engines like Perplexity, ChatGPT, and Claude.",
    ...
    siteName: SITE.name,
    images: [{ url: new URL("/aeo/opengraph-image", SITE.url).toString(), width: 1200, height: 630 }],
  },
  twitter: {
    card: "summary_large_image",
    title: `${SITE.name} | Answer Engine Optimization`,
    description:
      "Learn how Answer Engine Optimization can improve your visibility in AI-powered search engines.",
    images: [new URL("/aeo/opengraph-image", SITE.url).toString()],
  },
};
  ...
  return (
    <>
      ...
      <main className="font-sans overflow-x-hidden">
            ...
            <div className="grid md:grid-cols-[3fr_2fr] gap-12 md:gap-16 items-center">
              <div>
                <p className="text-lg sm:text-xl text-slate-600 leading-relaxed mb-10 max-w-2xl">
                  When your customers ask ChatGPT, Claude, or Perplexity for a <em>plumber near them</em>, a <em>salon in their neighborhood</em>, or a <em>contractor they can trust</em>, your business should be in the answer. Most aren&apos;t. We fix that.
                </p>
        ...
        <section className="px-6 py-28 sm:py-36 max-w-6xl mx-auto">
          <FadeUp>
            <SectionHeader number="06" title="Common questions." />
          </FadeUp>
          <div className="space-y-10 max-w-3xl">
            {faqs.map((f, i) => (              <FadeUp key={f.q} delay={i * 60}>
                <div>
        ...
        <footer className="px-6 py-12 max-w-6xl mx-auto border-t border-slate-200">
          <p className="text-xs text-slate-500 tracking-widest uppercase text-center">
            {SITE.name} • Answer Engine Optimization • {new Date().getFullYear()}
          </p>
        </footer>
      </main>
    </>
